      ...
      >
        ...
        <Card>
          ...
          <View style={styles.totalsGrid}>
            ...
            <View style={[styles.totalCell, { borderLeftColor: colors.warning }]}>
      ...
      <View style={styles.head}>
        <View style={{ flex: 1, gap: 2 }}>
          ...
          <ThemedText type="caption" color={colors.textTertiary}>
            {format(parseISO(purchase.purchased_at), 'dd MMM yyyy')} · {purchase.quantity} unit{purchase.quantity === 1 ? '' : 's'}
          </ThemedText>
        </View>
      ...
      {purchase.due_date && (
        <View style={[styles.dueRow, overdue && styles.dueRowOverdue]}>
          ...
          <ThemedText type="caption" color={overdue ? colors.danger : colors.textSecondary}>
            ...
            {format(parseISO(purchase.due_date), 'dd MMM yyyy')}
          </ThemedText>
        </View>
      )}
